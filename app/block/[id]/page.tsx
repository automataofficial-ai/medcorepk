    ...
    <div className="min-h-screen" style={{ background: "#050B18" }}>
      ...
      <div className="sticky top-0 z-40 border-b border-slate-800/50"
        ...
        <div className="max-w-4xl mx-auto px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between gap-2 sm:gap-4">
          <Link href="/dashboard" className="flex items-center gap-2 text-white hover:text-white transition-colors">
            <div className="w-8 h-8 rounded-full border-2 border-cyan-400 flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path stroke="currentColor" d="M3,12 L6,12 L8,4 L10,12 L12,12 L14,8 L16,12 L21,12" className="text-cyan-400" />
              </svg>
            </div>
